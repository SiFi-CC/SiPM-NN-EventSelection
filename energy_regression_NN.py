...
path = "./energy_regression_BP0mm"
input_path = "/net/data_g4rt/projects/SiFiCC/InputforNN/SiPMNNNewGeometry/FinalDetectorVersion_RasterCoupling_OPM_38e8protons.root"

model_name = "/increasing_NN_regression_peEnergy_4knorm_210323"
...
target_data = np.load(data_path+"energy_e_p_BP0mm_ep.npz")

check_point_name = path+"\best_energy_model_BP0mm.h5"

#input_data = np.load(data_path+"training_data_raster_bothneg_fullnorm_1632_2ch_midempty_BP5mm.npz")
#output_data = np.load(data_path+"ideal_targets_raster_BP5mm_ep.npz")
#target_data = np.load(data_path+"energy_e_p_BP5mm_ep.npz")


input_data = input_data['arr_0']
output_data = output_data['arr_0']
target_data = target_data['arr_0']
...
input_data = input_data[compton_idx]
...
print("################### \n complete data set size is:", input_data.shape[0], "\n ##################### \n")
...
history = model.fit(X_train, 
    ...
    verbose=1)
            ...
            batch_size = 64)#,
	   #  sample_weight=sample_weights[0:trainset_index])
