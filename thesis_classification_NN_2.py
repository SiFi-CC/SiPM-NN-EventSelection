...
path = "./thesis_models"
model_name = "/increasing_3103_3212_norm12k_dropout_manylayernorm_1664"
...
data_path = r"/disk1/farah/"
input_data_BP0mm = np.load(data_path+"training_data_bothneg_norm12k_1232_2ch_midempty_0mmBP.npz")
input_data_BP5mm = np.load(data_path+"training_data_bothneg_norm12k_1232_2ch_midempty_5mmBP.npz")
...
history = model.fit(X_train, 
           ...
           callbacks = [tf.keras.callbacks.ReduceLROnPlateau('val_loss', factor=0.1,patience=10,min_lr=0,verbose=1,min_lr=10**(-4)),
				tf.keras.callbacks.EarlyStopping('val_loss', patience=19),
