...
path = "./thesis_models"
model_name = "/increasing_0404_3216_norm4k_energy_regression_8128layers"
model_name = path+model_name
data_path = r"/.automount/home/home__home2/institut_3b/farah/Desktop/Data/"
checkpoint_filepath = model_name+"/best_model_energy_regression_shuffeldBP_step001_layernorm.h5"

#data_path_1232_12k = r"/disk1/farah/"
input_data_BP0mm = np.load(data_path+"training_data_bothneg_norm4k_1632_2ch_midempty_0mmBP_compton.npz")
input_data_BP5mm = np.load(data_path+"training_data_bothneg_norm4k_1632_2ch_midempty_5mmBP_compton.npz")


energy_e_p_BP0mm = np.load(data_path+"energy_e_p_BP0mm_ep.npz")
energy_e_p_BP5mm = np.load(data_path+"energy_e_p_BP5mm_ep.npz")


input_data_BP0mm = input_data_BP0mm['arr_0']
input_data_BP5mm = input_data_BP5mm['arr_0']

target_data_BP0mm = energy_e_p_BP0mm['arr_0']
target_data_BP5mm= energy_e_p_BP5mm['arr_0']
